...
- Next: AIS live collector (needs AISSTREAM_API_KEY), ML training notebook (needs Krestenitis dataset), real Sentinel-1 tiles (needs CDSE token), report PDF, Cesium, admin create-user form.
